...
import com.api.issuetacker.event.UserEmailVerificationSendEvent;
import com.api.issuetacker.event.UserPasswordResetSendEvent;
...
public class UserService {
     ...
     * @return Page
     */
    public Page<User> findAll(UserCriteria criteria, PaginationCriteria paginationCriteria) throws PageRequestBuilder.BadRequestException {
